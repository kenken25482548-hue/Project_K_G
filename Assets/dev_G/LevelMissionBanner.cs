...
public class LevelMissionBanner : MonoBehaviour
{
    ...
    public void Show(string missionNumber, string englishName, string thaiName)
    {
        ...
        TMP_FontAsset thaiFont = Resources.Load<TMP_FontAsset>("UI/Fonts/Sarabun-Bold SDF");
        TMP_FontAsset titleFont = Resources.Load<TMP_FontAsset>("UI/Fonts/ChakraPetch-Bold SDF");
